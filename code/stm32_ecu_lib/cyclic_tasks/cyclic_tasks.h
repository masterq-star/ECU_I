#ifndef _cyclicHandler
#define _cyclicHandler
...
extern void cyclicProcessingHFTasks(void);
extern void cyclicProcessingLFTasks(void);
extern void cyclicProcessingVLFTasks(void);
